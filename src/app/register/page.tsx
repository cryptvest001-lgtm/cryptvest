      ...
      <div className="relative z-10 w-full max-w-sm">
        ...
        <div className="glass p-8 space-y-6">
          <div className="text-center">
            ...
            <p className="mt-1 text-sm" style={{color:"rgba(226,232,240,0.5)"}}>Start your challenge today</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex items-center gap-2 rounded-xl px-3 py-2.5 text-xs"
              style={{background:"rgba(0,240,255,0.04)", border:"1px solid rgba(0,240,255,0.1)", color:"rgba(226,232,240,0.45)"}}>
              <span style={{color:"#22c55e"}}>✓</span> Free to join — no credit card required
            </div>
        ...
        <p className="mt-5 text-center text-sm" style={{color:"rgba(226,232,240,0.4)"}}>
          ...
          <Link href="/login" className="font-semibold transition-colors" style={{color:"#00f0ff"}}
