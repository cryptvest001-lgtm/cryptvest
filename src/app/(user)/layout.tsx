...
export default function UserLayout({
  ...
  return (
    <div className="min-h-screen flex" style={{ backgroundColor: "#0a0a0f" }}>
      ...
      <aside
        className={`fixed md:static inset-y-0 left-0 z-40 w-56 flex-shrink-0 flex flex-col border-r border-white/[0.06] transform transition-transform duration-300 md:translate-x-0 ${menuOpen ? "translate-x-0" : "-translate-x-full"}`}
        style={{
        ...
        <div className="px-5 py-5 border-b border-white/[0.06]">
          <Link href="/dashboard">
            <Image
              ...
              width={180}
              height={53}
              className="h-[3.25rem] w-auto brightness-0 invert"
            />
          </Link>
        </div>
